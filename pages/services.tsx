...
const Service = () => {
  ...
  return (
    <div
      className="mt-20 min-h-screen flex flex-col place-content-evenly "
      id="services"
    >
      <Head>
        <title>
          {router.asPath == "/services" ? "Our Services" : "Gigatorb"}
        </title>
        <meta name="description" content="Services Provide by Gigatorb" />
        <meta
          name="keywords"
