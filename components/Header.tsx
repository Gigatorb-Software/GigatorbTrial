...
const Header = () =>{
    ...
    return(
        ...
        {/* </div> */}
        <div className="">
          <div  className="text-3xl absolute right-8 top-2 cursor-pointer md:hidden">
          ...
          md:pl-0 pd-9 transition-all duration-500 ease-in ${'top-[-450px] md:opacity-100 opacity-0'}`}>
